...
//     const text = "hello.\n" +
//         "\n" +
//         "this text is ciphered with a grille. you can read and write a text with it.\n" +
//         "\n" +
//         "press toggle to show current grille.\n" +
//         "\n" +
//         "press shuffle to generate another pattern.\n" +
//         "\n" +
//         "press rotate or use arrows to rotate grille."; // Ваш заготовленный текст
//     let index = 0;
//
//     function typeText() {
...
//
//             setTimeout(typeText, 1); // Задержка в миллисекундах между добавлением символов
//         }
//     }
//
